...
type Hooks struct {
	...
	// Parameters provide the previous (old) full assignment slice and the new full assignment slice.
	// Implementations can derive added/removed partitions by diffing old vs new.
	// old: previous complete assignment set
	// new: new complete assignment set
