...
func (m *transientCaptureMetrics) IncrementWorkerConsumerIteratorEscalation(_ string) {}
func (m *transientCaptureMetrics) IncrementWorkerConsumerPullSuppressed(_ string)     {}
