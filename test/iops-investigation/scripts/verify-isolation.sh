...
#                 e.g. iops-nats-1,iops-nats-2,iops-nats-3
#
...
Live run output format:
  NATS [iops-nats-1] cpuset.cpus.effective: 0-7,16-23  OK
  NATS [iops-nats-2] cpuset.cpus.effective: 0-7,16-23  OK
  NATS [iops-nats-3] cpuset.cpus.effective: 0-7,16-23  OK
